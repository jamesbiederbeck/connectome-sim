...
PARAMETERS={**RULE_PARAMETERS,'neural_dt_ms':.1,'modulator_delivery_trace_ms':100.,
    'kc_rest_mV':-60.,'kc_adaptation_jump_mV':8.,'kc_adaptation_tau_ms':200.,
    'interpretation':'Combines v4 KC adaptation/rest hypothesis with v5 baseline-centered anti-Hebbian rate-rule adaptation on the full graph. Tonic currents calibrated to published baseline rates; associative gain and trace constants remain hypotheses. No game-based parameter fitting.'}
